...
Once the image has finished building, the command *s2i usage spring-boot* will print out the help info that was defined in the *usage* script.
...
```
s2i build test/test-app spring-boot spring-boot-app
